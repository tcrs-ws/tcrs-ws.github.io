...
## Submissions
TCRS '26 will work with [IEEE Embedded Systems Letters (ESL)](https://ieee-ceda.org/publication/esl) for paper submissions, reviews, and publication.
...
Papers submitted to TCRS '26 must follow the [IEEE ESL Paper Submission Instructions](https://ieee-ceda.org/publication/esl/esl-paper-submission).
...
On the next page, choose "**TCRS 2026**" under the dropdown menu.
After confirming the checkboxes, you will be prompted to upload your manuscript.

### Conflicts of Interest (COI) Requirements
...
This will show up as one of the required files during the **Upload Manuscript** step.

### Acceptance Tiers
At least one of the authors for each paper must fully register and present the accepted paper at the workshop.
TCRS '26 will have two tiers of final acceptance.
...
## Important Dates
- ~~June 22, 2026~~ (**Extended**) July 1, 2026: Paper submission deadline
- July 27, 2026: Notification of Acceptance.
- Within 1 week of acceptance notification: Final manuscript and video graphical abstract deadline (video graphical abstract is only required for papers with *Present-and-publish acceptance*)
- August 17, 2026: Final acceptance notification
- October 8--9, 2026: Paper presentations.
